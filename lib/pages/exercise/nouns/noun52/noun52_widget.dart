...
import 'noun52_model.dart';
export 'noun52_model.dart';

class Noun52Widget extends StatefulWidget {
  const Noun52Widget({
    super.key,
    required this.decl,
    required this.ns,
    ...
    required this.noun31,
    required this.noun32,
    required this.noun41,
    required this.noun42,
    required this.noun51,
    required this.qn,
  });
  ...
  static String routeName = 'noun52';
  static String routePath = '/noun52';

  @override
  State<Noun52Widget> createState() => _Noun52WidgetState();
}

class _Noun52WidgetState extends State<Noun52Widget> {
  late Noun52Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun52Model());
                                ...
                                onFieldSubmitted: (_) async {
                                  ...
                                  context.goNamed(
                                    ...
                                    queryParameters: {
                                      ...
                                      'noun32': serializeParam(
                                        widget!.noun32,
                                        ParamType.String,
                                      ),
                                      'noun41': serializeParam(
                                        widget!.noun41,
                                        ParamType.String,
                                      ),
                                      'noun42': serializeParam(
                                        widget!.noun42,
                                        ParamType.String,
                                      ),
                                      'noun51': serializeParam(
                                        widget!.noun51,
                                        ParamType.String,
                                      ),
                                      'noun52': serializeParam(
