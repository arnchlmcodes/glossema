...
import 'noun42_model.dart';
export 'noun42_model.dart';

class Noun42Widget extends StatefulWidget {
  const Noun42Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun42';
  static String routePath = '/noun42';

  @override
  State<Noun42Widget> createState() => _Noun42WidgetState();
}

class _Noun42WidgetState extends State<Noun42Widget> {
  late Noun42Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun42Model());
