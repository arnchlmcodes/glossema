...
import 'noun12_model.dart';
export 'noun12_model.dart';

class Noun12Widget extends StatefulWidget {
  const Noun12Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun12';
  static String routePath = '/noun12';

  @override
  State<Noun12Widget> createState() => _Noun12WidgetState();
}

class _Noun12WidgetState extends State<Noun12Widget> {
  late Noun12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun12Model());
