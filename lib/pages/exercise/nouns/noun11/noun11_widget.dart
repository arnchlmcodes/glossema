...
import 'noun11_model.dart';
export 'noun11_model.dart';

class Noun11Widget extends StatefulWidget {
  const Noun11Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun11';
  static String routePath = '/noun11';

  @override
  State<Noun11Widget> createState() => _Noun11WidgetState();
}

class _Noun11WidgetState extends State<Noun11Widget> {
  late Noun11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun11Model());
