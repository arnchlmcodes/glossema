...
import 'noun22_model.dart';
export 'noun22_model.dart';

class Noun22Widget extends StatefulWidget {
  const Noun22Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun22';
  static String routePath = '/noun22';

  @override
  State<Noun22Widget> createState() => _Noun22WidgetState();
}

class _Noun22WidgetState extends State<Noun22Widget> {
  late Noun22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun22Model());
