...
import 'noun21_model.dart';
export 'noun21_model.dart';

class Noun21Widget extends StatefulWidget {
  const Noun21Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun21';
  static String routePath = '/noun21';

  @override
  State<Noun21Widget> createState() => _Noun21WidgetState();
}

class _Noun21WidgetState extends State<Noun21Widget> {
  late Noun21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun21Model());
