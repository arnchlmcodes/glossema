...
import 'noun32_model.dart';
export 'noun32_model.dart';

class Noun32Widget extends StatefulWidget {
  const Noun32Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun32';
  static String routePath = '/noun32';

  @override
  State<Noun32Widget> createState() => _Noun32WidgetState();
}

class _Noun32WidgetState extends State<Noun32Widget> {
  late Noun32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun32Model());
