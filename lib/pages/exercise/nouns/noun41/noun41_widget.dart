...
import 'noun41_model.dart';
export 'noun41_model.dart';

class Noun41Widget extends StatefulWidget {
  const Noun41Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun41';
  static String routePath = '/noun41';

  @override
  State<Noun41Widget> createState() => _Noun41WidgetState();
}

class _Noun41WidgetState extends State<Noun41Widget> {
  late Noun41Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun41Model());
