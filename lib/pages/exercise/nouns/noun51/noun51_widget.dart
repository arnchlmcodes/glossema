...
import 'noun51_model.dart';
export 'noun51_model.dart';

class Noun51Widget extends StatefulWidget {
  const Noun51Widget({
    super.key,
    required this.decl,
    required this.ns,
  ...
  static String routeName = 'noun51';
  static String routePath = '/noun51';

  @override
  State<Noun51Widget> createState() => _Noun51WidgetState();
}

class _Noun51WidgetState extends State<Noun51Widget> {
  late Noun51Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Noun51Model());
