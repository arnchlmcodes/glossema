...
import 'adjs31_model.dart';
export 'adjs31_model.dart';

class Adjs31Widget extends StatefulWidget {
  const Adjs31Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs31';
  static String routePath = '/adjs31';

  @override
  State<Adjs31Widget> createState() => _Adjs31WidgetState();
}

class _Adjs31WidgetState extends State<Adjs31Widget> {
  late Adjs31Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs31Model());
