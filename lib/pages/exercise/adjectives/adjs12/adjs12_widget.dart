...
import 'adjs12_model.dart';
export 'adjs12_model.dart';

class Adjs12Widget extends StatefulWidget {
  const Adjs12Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs12';
  static String routePath = '/adjs12';

  @override
  State<Adjs12Widget> createState() => _Adjs12WidgetState();
}

class _Adjs12WidgetState extends State<Adjs12Widget> {
  late Adjs12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs12Model());
