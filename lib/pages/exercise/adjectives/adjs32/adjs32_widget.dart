...
import 'adjs32_model.dart';
export 'adjs32_model.dart';

class Adjs32Widget extends StatefulWidget {
  const Adjs32Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs32';
  static String routePath = '/adjs32';

  @override
  State<Adjs32Widget> createState() => _Adjs32WidgetState();
}

class _Adjs32WidgetState extends State<Adjs32Widget> {
  late Adjs32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs32Model());
