...
import 'adjs51_model.dart';
export 'adjs51_model.dart';

class Adjs51Widget extends StatefulWidget {
  const Adjs51Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs51';
  static String routePath = '/adjs51';

  @override
  State<Adjs51Widget> createState() => _Adjs51WidgetState();
}

class _Adjs51WidgetState extends State<Adjs51Widget> {
  late Adjs51Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs51Model());
