...
import 'adjs42_model.dart';
export 'adjs42_model.dart';

class Adjs42Widget extends StatefulWidget {
  const Adjs42Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs42';
  static String routePath = '/adjs42';

  @override
  State<Adjs42Widget> createState() => _Adjs42WidgetState();
}

class _Adjs42WidgetState extends State<Adjs42Widget> {
  late Adjs42Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs42Model());
