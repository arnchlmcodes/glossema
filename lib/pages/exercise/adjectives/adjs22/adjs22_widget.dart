...
import 'adjs22_model.dart';
export 'adjs22_model.dart';

class Adjs22Widget extends StatefulWidget {
  const Adjs22Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs22';
  static String routePath = '/adjs22';

  @override
  State<Adjs22Widget> createState() => _Adjs22WidgetState();
}

class _Adjs22WidgetState extends State<Adjs22Widget> {
  late Adjs22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs22Model());
