...
import 'adjs41_model.dart';
export 'adjs41_model.dart';

class Adjs41Widget extends StatefulWidget {
  const Adjs41Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'adjs41';
  static String routePath = '/adjs41';

  @override
  State<Adjs41Widget> createState() => _Adjs41WidgetState();
}

class _Adjs41WidgetState extends State<Adjs41Widget> {
  late Adjs41Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adjs41Model());
