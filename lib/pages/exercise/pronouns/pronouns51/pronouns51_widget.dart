...
import 'pronouns51_model.dart';
export 'pronouns51_model.dart';

class Pronouns51Widget extends StatefulWidget {
  const Pronouns51Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns51';
  static String routePath = '/pronouns51';

  @override
  State<Pronouns51Widget> createState() => _Pronouns51WidgetState();
}

class _Pronouns51WidgetState extends State<Pronouns51Widget> {
  late Pronouns51Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns51Model());
