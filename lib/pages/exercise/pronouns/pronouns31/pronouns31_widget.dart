...
import 'pronouns31_model.dart';
export 'pronouns31_model.dart';

class Pronouns31Widget extends StatefulWidget {
  const Pronouns31Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns31';
  static String routePath = '/pronouns31';

  @override
  State<Pronouns31Widget> createState() => _Pronouns31WidgetState();
}

class _Pronouns31WidgetState extends State<Pronouns31Widget> {
  late Pronouns31Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns31Model());
