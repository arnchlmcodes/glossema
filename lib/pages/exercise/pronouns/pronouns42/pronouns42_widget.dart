...
import 'pronouns42_model.dart';
export 'pronouns42_model.dart';

class Pronouns42Widget extends StatefulWidget {
  const Pronouns42Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns42';
  static String routePath = '/pronouns42';

  @override
  State<Pronouns42Widget> createState() => _Pronouns42WidgetState();
}

class _Pronouns42WidgetState extends State<Pronouns42Widget> {
  late Pronouns42Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns42Model());
