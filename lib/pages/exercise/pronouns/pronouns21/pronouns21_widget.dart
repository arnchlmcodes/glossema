...
import 'pronouns21_model.dart';
export 'pronouns21_model.dart';

class Pronouns21Widget extends StatefulWidget {
  const Pronouns21Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns21';
  static String routePath = '/pronouns21';

  @override
  State<Pronouns21Widget> createState() => _Pronouns21WidgetState();
}

class _Pronouns21WidgetState extends State<Pronouns21Widget> {
  late Pronouns21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns21Model());
