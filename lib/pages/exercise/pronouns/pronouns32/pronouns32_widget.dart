...
import 'pronouns32_model.dart';
export 'pronouns32_model.dart';

class Pronouns32Widget extends StatefulWidget {
  const Pronouns32Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns32';
  static String routePath = '/pronouns32';

  @override
  State<Pronouns32Widget> createState() => _Pronouns32WidgetState();
}

class _Pronouns32WidgetState extends State<Pronouns32Widget> {
  late Pronouns32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns32Model());
