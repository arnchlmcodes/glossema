...
import 'pronouns12_model.dart';
export 'pronouns12_model.dart';

class Pronouns12Widget extends StatefulWidget {
  const Pronouns12Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns12';
  static String routePath = '/pronouns12';

  @override
  State<Pronouns12Widget> createState() => _Pronouns12WidgetState();
}

class _Pronouns12WidgetState extends State<Pronouns12Widget> {
  late Pronouns12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns12Model());
