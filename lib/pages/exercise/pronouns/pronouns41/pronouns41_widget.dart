...
import 'pronouns41_model.dart';
export 'pronouns41_model.dart';

class Pronouns41Widget extends StatefulWidget {
  const Pronouns41Widget({
    super.key,
    required this.word,
  ...
  static String routeName = 'pronouns41';
  static String routePath = '/pronouns41';

  @override
  State<Pronouns41Widget> createState() => _Pronouns41WidgetState();
}

class _Pronouns41WidgetState extends State<Pronouns41Widget> {
  late Pronouns41Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pronouns41Model());
