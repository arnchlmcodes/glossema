...
import 'verb04_model.dart';
export 'verb04_model.dart';

class Verb04Widget extends StatefulWidget {
  const Verb04Widget({
    super.key,
    required this.decl,
    required this.qn,
  ...
  static String routeName = 'verb04';
  static String routePath = '/verb04';

  @override
  State<Verb04Widget> createState() => _Verb04WidgetState();
}

class _Verb04WidgetState extends State<Verb04Widget> {
  late Verb04Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Verb04Model());
