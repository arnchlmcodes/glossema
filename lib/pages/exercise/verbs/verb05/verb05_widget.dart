...
import 'verb05_model.dart';
export 'verb05_model.dart';

class Verb05Widget extends StatefulWidget {
  const Verb05Widget({
    super.key,
    required this.decl,
    required this.qn,
  ...
  static String routeName = 'verb05';
  static String routePath = '/verb05';

  @override
  State<Verb05Widget> createState() => _Verb05WidgetState();
}

class _Verb05WidgetState extends State<Verb05Widget> {
  late Verb05Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Verb05Model());
