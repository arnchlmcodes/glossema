...
import 'verb01_model.dart';
export 'verb01_model.dart';

class Verb01Widget extends StatefulWidget {
  const Verb01Widget({
    super.key,
    required this.decl,
    required this.qn,
  ...
  static String routeName = 'verb01';
  static String routePath = '/verb01';

  @override
  State<Verb01Widget> createState() => _Verb01WidgetState();
}

class _Verb01WidgetState extends State<Verb01Widget> {
  late Verb01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Verb01Model());
