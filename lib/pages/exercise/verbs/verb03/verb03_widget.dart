...
import 'verb03_model.dart';
export 'verb03_model.dart';

class Verb03Widget extends StatefulWidget {
  const Verb03Widget({
    super.key,
    required this.decl,
    required this.qn,
  ...
  static String routeName = 'verb03';
  static String routePath = '/verb03';

  @override
  State<Verb03Widget> createState() => _Verb03WidgetState();
}

class _Verb03WidgetState extends State<Verb03Widget> {
  late Verb03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Verb03Model());
